$(document).ready(function() {
    ...
    $('.search-book-button').click(function(e) {
        ...
        swal({
                title: "¿Qué audiolibro estás buscando?",
                text: "Por favor escribe el nombre del audiolibro",
                type: "input",
                showCancelButton: true,
                closeOnConfirm: false,
                animation: "slide-from-top",
                ...
                inputPlaceholder: "Escribe aquí el nombre del audiolibro"
            },
            function(inputValue) {
                if (inputValue === false) return false;

                if (inputValue === "") {
                    swal.showInputError("Debes escribir el nombre del audiolibro");
                    return false;
                }
